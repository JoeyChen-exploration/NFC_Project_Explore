          ...
          <>
            ...
            >
              ...
              <StatCard
                label="点击率"
                value={
                  stats.summary.total_page_views > 0
            ...
            <Section title="过去 7 天访问趋势">
              {stats.daily_views_7d.length === 0 ? (
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <AreaChart
                    data={fillDays(stats.daily_views_7d)}
                    margin={{ top: 10, right: 10, left: -20, bottom: 0 }}
                  >
                    <defs>
                      <linearGradient id="grad" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="5%" stopColor="var(--c-accent)" stopOpacity={0.15} />
            ...
            <Section title="链接点击排行（近 30 天）" style={{ marginTop: 20 }}>
              {stats.clicks_per_link.length === 0 ? (
                ...
                <>
                  <ResponsiveContainer
                    width="100%"
                    height={Math.max(160, stats.clicks_per_link.length * 44)}
                  >
                    <BarChart
                    ...
                    >
                      ...
                      <Bar dataKey="clicks" name="点击数" radius={[0, 6, 6, 0]}>
                        {stats.clicks_per_link.map((_, i) => (
                          <Cell
                            key={i}
                            fill={`hsl(${217 - i * 14}, ${80 - i * 4}%, ${52 + i * 3}%)`}
                          />
                        ))}
                      </Bar>
                    </BarChart>
